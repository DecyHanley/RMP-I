package {
	...
	public class CmmInfo extends PanelScreen {
		...
		public function CmmInfo() {
			super();
			this.addEventListener(FeathersEventType.INITIALIZE, initializeHandler);
		}
		private function initializeHandler(): void {
			this.removeEventListener(FeathersEventType.INITIALIZE, initializeHandler);
			this.headerProperties.title = "Creative Multimedia Info";
		...
		private function contentPanelContent() {
			...
			var cmmXML: XML = this.assetMgr.getXml("cmmInfo");
			this.scrollTxt = new ScrollText();
			this.scrollTxt.text = cmmXML.info;
