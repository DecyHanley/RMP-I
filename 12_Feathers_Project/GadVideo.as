package {
	...
	public class GadVideo extends PanelScreen {
		...
		private function initializeHandler(): void {
			...
			this.headerProperties.title = "Game Art + Design Video";
		...
		private function handlePlayPauseButtonClick(e: Event): void {
			if (!videoPlaying) {
				videoStream.play("assets/gadAssets/videos/x_factor_test.flv");
