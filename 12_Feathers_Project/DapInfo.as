package {
	...
	public class DapInfo extends PanelScreen {
		...
		private function initializeHandler(): void {
			...
			this.headerProperties.title = "Digital Animation Production Information";
		...
		private function contentPanelContent() {
			...
			var dapXML: XML = this.assetMgr.getXml("dapInfo");
			this.scrollTxt = new ScrollText();
			this.scrollTxt.text = dapXML.info;
