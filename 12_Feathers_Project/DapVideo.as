package {
	...
	public class DapVideo extends PanelScreen {
		...
		private function initializeHandler(): void {
			...
			this.headerProperties.title = "Digital Animation Production Video";
		...
		private function handlePlayPauseButtonClick(e: Event): void {
			if (!videoPlaying) {
				videoStream.play("assets/dapAssets/videos/dap_video.mp4");
